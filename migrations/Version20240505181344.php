 ...
 */
final class Version20240505181344 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE devis (id INT NOT NULL, id_client_id INT NOT NULL, id_entreprise_id INT NOT NULL, id_lots_id INT NOT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, description VARCHAR(255) NOT NULL, statut INT NOT NULL, taxe DOUBLE PRECISION NOT NULL, total_ht DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE services (id INT NOT NULL, id_cat_services_id INT NOT NULL, nom VARCHAR(100) NOT NULL, prix INT NOT NULL, PRIMARY KEY(id))');
