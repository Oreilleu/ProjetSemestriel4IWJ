...
class RolesController extends AbstractController
{
    ...
    #[Route('/{userd_id}', name: 'app_roles_show', methods: ['GET'])]
    ...
    #[Route('/{userd_id}/edit', name: 'app_roles_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{userd_id}', name: 'app_roles_delete', methods: ['POST'])]
    public function delete(Request $request, Roles $role, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$role->getUserd_id(), $request->request->get('_token'))) {
